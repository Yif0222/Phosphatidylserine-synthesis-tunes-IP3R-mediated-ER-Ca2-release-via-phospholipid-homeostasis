...
# ============================================================
# Usage: python Figure1J_PCA.py [input_file] [output_file]
#   input_file:  tab-separated data file (default: "Total lipids.txt")
#   output_file: output PNG path (default: "Figure1J_PCA.png")
# ============================================================
...
if len(sys.argv) >= 2:
    ...
    DATA_PATH = os.path.join(script_dir, 'Total lipids.txt')

if len(sys.argv) >= 3:
    OUTPUT_PATH = sys.argv[2]
else:
    OUTPUT_PATH = os.path.join(script_dir, 'Figure1J_PCA.png')
